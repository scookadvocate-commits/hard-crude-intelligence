...
// ─── PRICES ──────────────────────────────────────────────────────────────────
const PRICES = {
  brent: { price: 91.4, change: 17.15, high: 94.8, low: 72.87 },
  wti: { price: 87.2, change: 16.38, high: 90.5, low: 67.02 },
  wcs: { price: 68.9, change: 16.56, high: 71.2, low: 57.6 },
  opec: { price: 93.1, change: 16.88, high: 96.4, low: 78.1 },
  dubai: { price: 89.8, change: 16.72, high: 93.1, low: 75.3 },
  urals: { price: 70.2, change: 13.71, high: 72.5, low: 61.75 },
  bonny: { price: 94.3, change: 17.04, high: 97.6, low: 79.2 },
  maya: { price: 76.4, change: 16.81, high: 79.2, low: 65.4 },
  arab_light: { price: 92.1, change: 16.92, high: 95.3, low: 77.05 },
};
const GRADES = [
  {
    id: "brent",
...
const NEWS = {
  geopolitical: [
    {
      headline:
        "CONFIRMED: Ayatollah Ali Khamenei Killed in US-Israeli Strike on Tehran Compound",
      summary:
        "Iranian state television has confirmed the death of Supreme Leader Ayatollah Ali Khamenei, who held power since 1989. He was killed by an Israeli airstrike on his compound in Tehran's Pasteur district. Trump announced his death on Truth Social, calling him 'one of the most evil people in history.' Khamenei's daughter, son-in-law, and grandson were also killed in the strike. Iran has declared 40 days of mourning and vowed the 'most ferocious offensive in its history' in retaliation.",
      source: "CNN / Al Jazeera / WaPo",
      time: "LIVE",
      region: "Tehran / Iran",
    },
    {
      headline:
        "Iran Restricts Strait of Hormuz — IRGC Ordering Ships Not to Pass",
      summary:
        "Iran's Revolutionary Guard is broadcasting marine radio warnings instructing vessels not to transit the Strait of Hormuz. An EU naval mission official confirmed the restriction to Reuters. Several oil companies and trading firms have already paused crude shipments through the waterway. Barclays warned: 'Oil markets might have to face their worst fears on Monday.' The waterway carries 20 million barrels per day — 20% of global seaborne oil.",
      source: "Reuters / Fox Business",
      time: "2h ago",
      region: "Strait of Hormuz",
    },
    {
      headline:
        "Dubai International Airport — World's Busiest for International Flights — Closed Indefinitely",
      summary:
    ...
    {
      headline:
        "Iran Fires Missiles at Tel Aviv — 21 Injured, Fires Burn in City Centre",
      summary:
        "Iranian ballistic missiles struck central Tel Aviv overnight, injuring at least 21 people. Fires burned across several districts as Israel's Iron Dome intercepted incoming projectiles. Israel has declared a state of emergency nationwide. Netanyahu confirmed a second wave of Israeli strikes on missile launchers in central Iran has commenced. Bombing will continue 'throughout the week or as long as necessary,' Trump said.",
    ...
    {
      headline:
        "Trump: Bombing Will Continue 'Throughout the Week' — Regime Change the Objective",
      summary:
        "President Trump posted on Truth Social that bombing would continue 'uninterrupted throughout the week or as long as necessary.' Both Trump and Netanyahu have explicitly stated regime change as their goal. Trump urged Iranians: 'When we are finished, take over your government. It will be yours to take.' The UN Secretary General warned: 'Military action carries the risk of igniting a chain of events that no one can control.'",
      source: "Truth Social / NBC News",
      time: "5h ago",
      region: "USA / Iran",
    },
  ],
  opec: [
    {
      headline:
        "OPEC+ Emergency Meeting Sunday — Saudi Arabia Prepares Maximum Output as Hormuz Restricted",
      summary:
        "With Hormuz now under restriction, Sunday's OPEC+ emergency session has taken on critical importance. Saudi Arabia and UAE are preparing to signal maximum possible output increases, but their own exports also transit the Strait of Hormuz. If the restriction hardens into a full blockade, no amount of OPEC spare capacity can compensate — the bottleneck is geographic, not volume-based.",
      source: "Reuters",
      time: "1h ago",
      region: "Saudi Arabia / OPEC+",
    },
    {
      headline:
        "Iran's Kharg Island Export Terminal: Still Operational — But For How Long?",
      summary:
        "Despite the scale of strikes across Iran, Kharg Island — through which 90% of Iran's crude exports flow — has not been confirmed as a direct target as of Saturday evening. Energy analysts say this is deliberate: the US and Israel are using Kharg as leverage. Any strike on Kharg would remove 3 million bpd from global markets instantly. Several tanker operators have preemptively suspended loadings pending security assessment.",
  ...
  economic: [
    {
      headline:
        "Barclays: 'Oil Markets May Face Their Worst Fears Monday' — Brent $100 Now Base Case",
      summary:
        "Barclays issued its starkest warning yet: 'Oil markets might have to face their worst fears on Monday.' With Hormuz restricted and Khamenei confirmed dead, the bank has shifted its $100/bbl Brent call from tail risk to base case. Eurasia Group projected a $5–10 increase above Friday's $73 baseline as a minimum if restrictions continue into Sunday. Asian markets open first — the initial price signal will come from Singapore and Tokyo.",
      source: "Barclays / Reuters",
      time: "2h ago",
      region: "Global Markets",
    },
    {
      headline:
        "IEA Calls Emergency Governing Board Session — Coordinated SPR Release Being Finalised",
      summary:
        "The IEA's governing board convened an emergency session, with member nations moving toward a coordinated strategic petroleum reserve release potentially larger than the 60 million barrel package deployed after Russia's 2022 Ukraine invasion. The White House has separately authorised a unilateral US SPR release of up to 30 million barrels targeting Monday's Asian market open.",
      source: "WSJ / Reuters",
      time: "4h ago",
      region: "IEA / USA",
    },
    {
      headline:
        "Goldman Sachs Revises Brent Worst Case to $130 if Hormuz Fully Closed for One Week",
      summary:
        "Goldman Sachs issued a second emergency commodity note revising its worst-case Brent scenario sharply higher. A full Hormuz closure sustained for one week would push Brent to $130/bbl. The bank's new base case, assuming partial Hormuz restriction resolved within 48–72 hours, is $95–105/bbl at Monday's open. The note described this as 'the most significant oil supply risk event since 1973.'",
    ...
    {
      headline:
        "Asian Stock Futures Collapse — Nikkei Down 4%, Hang Seng Down 5% in Pre-Market",
      summary:
    ...
    {
      headline:
        "US Gasoline Futures Signal $5/Gallon Pump Prices Within Two Weeks if Hormuz Stays Restricted",
      summary:
        "US retail gasoline futures are pricing in pump prices of $4.80–5.10 per gallon within two weeks if Hormuz restrictions persist. The White House confirmed an SPR release and said the administration is 'doing everything possible' to protect American consumers. GasBuddy upgraded its forecast to a 50–75 cent per gallon increase in the next 10 days.",
  ...
  climate: [
    {
      headline:
        "Energy Transition Narrative Collapses Overnight — Fossil Fuel Security Back at Top of Every Agenda",
      summary:
        "The Khamenei killing and Hormuz restriction have abruptly ended what remained of the energy transition narrative in government policy circles. European energy ministers are convening emergency sessions, coal plant restarts are being fast-tracked, and LNG import capacity approvals are being rubber-stamped. The crisis has exposed that the world remains entirely dependent on fossil fuel infrastructure with no alternative capable of absorbing a supply shock of this magnitude.",
      source: "FT",
      time: "3h ago",
      region: "Global",
    },
    ...
    {
      headline:
        "IEA Emergency Assessment: Current Crisis Exceeds 1973 Embargo in Potential Severity",
      summary:
        "The IEA's emergency assessment concluded that the combination of Iranian supply disruption, Hormuz restriction, and Iraqi export halt represents a potential supply shock exceeding the 1973 Arab Embargo. The 1973 embargo removed 4–5 million bpd. The current scenario, if Hormuz is fully closed, would remove 20 million bpd — four times larger.",
      source: "IEA",
      time: "6h ago",
      region: "Global",
    },
    ...
    {
      headline:
        "Coal Restarts Accelerate — Germany, Poland, UK Reactivating Mothballed Plants",
      summary:
        "Germany, Poland, and the United Kingdom confirmed emergency reactivation of mothballed coal-fired power stations as insurance against a sustained oil and gas supply shock. Energy ministers have invoked emergency powers to bypass normal environmental review processes. RWE, PGE, and Drax confirmed additional capacity can be online within 72 hours.",
  ...
  demand: [
    ...
    {
      headline:
        "Shipping Paralysis: 47 Tankers Anchored Outside Hormuz — $2 Billion of Crude Stranded",
      summary:
        "Kpler reports 47 loaded crude tankers at anchor outside the Strait of Hormuz, unable to transit due to IRGC warnings. The stranded vessels carry an estimated 47–55 million barrels — approximately $2 billion at current prices. Lloyd's of London has suspended war-risk coverage for Hormuz transit entirely, making insurance-backed passage legally impossible for most commercial operators.",
    ...
    {
      headline:
        "India Declares National Energy Emergency — First in the Country's History",
      summary:
    ...
    {
      headline:
        "Global Shipping Rates Surge 85% in Single Day — Worst Since COVID Port Closures",
      summary:
        "The Baltic Exchange dirty tanker rate index surged 85% in Saturday trading — the largest single-day move since COVID-era port closures in 2020. Very Large Crude Carrier day rates have jumped from $35,000 to $85,000 in 24 hours. Vessels capable of loading in the US Gulf, West Africa, and North Sea are being booked at any price.",
  ...
  geopolitical: [
    {
      y: "1973",
      t: "Arab Oil Embargo",
      d: "OAPEC cuts supply to punish US/Netherlands support for Israel. Oil quadruples. The IEA is founded in direct response. Energy security enters the geopolitical lexicon permanently.",
    },
    {
      y: "1979–80",
      t: "Iranian Revolution & Iran-Iraq War",
      d: "Shah's fall removes 5.7m bpd. Ensuing war adds further disruption. The Carter Doctrine commits US military force to Gulf oil defence — defining US Middle East policy for 40+ years.",
    },
    {
      y: "1990",
      t: "Gulf War",
      d: "Iraq invades Kuwait, removes 4.3m bpd. Swift coalition response and first SPR deployment show that coordinated political action can cap price spikes from geopolitical disruptions.",
    },
    {
      y: "2011",
      t: "Arab Spring & Libya Collapse",
      d: "Libya's civil war removes 1.6m bpd. Unrest across Yemen, Bahrain, Syria creates a persistent Middle East risk premium. OPEC loses a major member to chronic instability.",
    },
    {
      y: "2022",
      t: "Russia-Ukraine War",
      d: "Largest energy shock since 1973. Europe replaces Russian pipeline gas with LNG. Russia pivots to India and China at deep discounts. Western sanctions create a permanently bifurcated global oil market.",
    },
  ],
  opec: [
    {
      y: "1960",
      t: "OPEC Founded in Baghdad",
      d: "Venezuela and Arab nations create OPEC to counter the Western 'Seven Sisters' who unilaterally set prices. The founding shifts the centre of oil power from consuming to producing nations.",
    },
    {
      y: "1973",
      t: "First Oil Weapon",
      d: "OPEC demonstrates it can weaponise oil geopolitically — transferring ~$70 billion annually from consumers to producers and permanently altering the global economic order.",
    },
    {
      y: "1986",
      t: "Saudi Price War & Internal Breakdown",
      d: "Tired of cutting while others cheat, Saudi Arabia floods the market. The cartel's chronic discipline problem — still present today — is exposed in full.",
    },
    {
      y: "2016",
      t: "OPEC+ Alliance Created",
      d: "The shale-driven price collapse forces Saudi Arabia and Russia together. 23 nations sign the Declaration of Cooperation — the most significant restructuring of global oil governance since 1960.",
    },
    {
      y: "2020",
      t: "9.7 Million bpd Historic Cut",
      d: "COVID forces the largest coordinated production cut in history. Saudi Arabia and Russia set aside their March 2020 price war within weeks, proving the alliance can survive extreme stress.",
    },
  ],
  economic: [
    {
      y: "1973–74",
      t: "Stagflation Invented",
      d: "The oil shock drives double-digit inflation while simultaneously causing recession — 'stagflation' — a combination economists thought impossible. It ends the postwar Keynesian economic consensus.",
    },
    {
      y: "1986",
      t: "Soviet Fiscal Crisis Begins",
      d: "The Saudi-driven price crash halves Soviet hard currency earnings. Many historians mark this as the beginning of the fiscal crisis that ended the USSR in 1991.",
    },
    {
      y: "1998",
      t: "$10 Oil Forces OPEC Emergency",
      d: "Asian crisis demand collapse plus OPEC quota increase drives prices below $10/bbl. Forces emergency cartel coordination — the template for modern OPEC crisis management.",
    },
    {
      y: "2008",
      t: "$147 Peak and 75% Crash",
      d: "Oil's parabolic rise contributed to consumer squeeze that deepened the financial crisis; its collapse reflected the severity of demand destruction. The six-month range: $147 to $35.",
    },
    {
      y: "2020",
      t: "Negative Oil: -$37.63/bbl",
      d: "WTI May futures trade negative for the only time in history as Cushing storage fills physically. Financial market mechanics collide with physical commodity reality in an event no model predicted.",
    },
  ],
  climate: [
    {
      y: "1988",
      t: "IPCC Founded",
      d: "The Intergovernmental Panel on Climate Change begins the scientific consensus-building that will ultimately challenge the long-term future of fossil fuels as the world's primary energy source.",
    },
    {
      y: "1997",
      t: "Kyoto Protocol",
      d: "First binding international climate agreement. Oil industry dismisses it — but it begins the regulatory trajectory that now drives ESG investing, carbon pricing, and energy transition capital allocation.",
    },
    {
      y: "2015",
      t: "Paris Agreement",
      d: "196 nations commit to limiting warming to 1.5–2°C. The IEA subsequently calculates that no new oil and gas fields should be approved after 2021 to meet this target.",
    },
    {
      y: "2021",
      t: "IEA Net Zero Report",
      d: "The world's energy watchdog declares peak oil demand achievable by 2030 under aggressive transition — a seismic shift from an institution that once only tracked fossil fuel supply.",
    },
    {
      y: "2023",
      t: "EV Price Parity in China",
      d: "Electric vehicles reach price parity with combustion cars in China. Global EV sales hit 14 million. Oil demand displacement from EVs becomes statistically measurable for the first time.",
    },
  ],
  demand: [
    {
      y: "1908",
      t: "Ford Model T",
      d: "Mass automobile production begins the century-long marriage of oil and transportation. Within 20 years: 23 million registered US vehicles. Within 50 years: the oil-dependent suburban civilisation.",
    },
    {
      y: "1950s",
      t: "The Postwar Automobile Age",
      d: "Western suburbanisation, the US interstate highway system, and cheap gasoline create car-dependent civilisation. Decisions made in the 1950s about urban planning still lock in oil demand today.",
    },
    {
      y: "1993",
      t: "China Becomes Oil Importer",
      d: "China shifts from oil exporter to net importer. Over the next 30 years it adds 10 million bpd of demand — the single greatest demand growth story in oil history.",
    },
    {
      y: "2000s",
      t: "Aviation Democratised",
      d: "Low-cost carriers make air travel a mass market. Jet fuel becomes one of the fastest-growing demand categories — now 7% of global oil consumption and the hardest sector to decarbonise.",
    },
    {
      y: "2020s",
      t: "India's Turn",
      d: "With 1.4 billion people and rapid motorisation, India replicates China's demand growth story. Expected to add 4 million bpd by 2040, making it the defining demand variable of the next decade.",
    },
  ],
};
...
function PriceChart() {
  ...
  const area =
    `M${xS(1970)},${yS(0)} ` +
    HISTORY_PRICES.map((d) => `L${xS(d.y)},${yS(d.p)}`).join(" ") +
    ` L${xS(2026)},${yS(0)} Z`;
  return (
    <div
      style={{
          ...
          return (
            ...
            >
              <circle
                ...
                cy={yS(d.p)}
                r={hovered?.y === e.y ? 5 : 3}
                fill={hovered?.y === e.y ? "#fbbf24" : "#f97316"}
                stroke="#0f172a"
                strokeWidth={1.5}
              />
              <line
              ...
              <text
                ...
                textAnchor="middle"
                fontSize={6}
                fill={hovered?.y === e.y ? "#fbbf24" : "#6b7280"}
                fontFamily="monospace"
              >
                {e.l}
              </text>
...
function Gauge({ value, max, color }) {
  ...
  const toRad = (d) => (d * Math.PI) / 180,
    ax = (a) => cx + r * Math.cos(toRad(a)),
    ay = (a) => cy + r * Math.sin(toRad(a));
  const sa = -210,
    sw = 240,
    ea = sa + sw * pct;
  ...
  const fD =
    pct > 0.01
      ? `M${ax(sa)} ${ay(sa)} A${r} ${r} 0 ${sw * pct > 180 ? 1 : 0} 1 ${ax(ea)} ${ay(ea)}`
      : "";
  return (
    <svg width={72} height={58} viewBox="0 0 72 72">
      ...
      <text x={cx} y={cy + 16} textAnchor="middle" fontSize={7} fill="#94a3b8">
        API°
      </text>
    </svg>
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1.5px solid ${hov ? "#0369a1" : "#e2e8f0"}`,
        borderTop: `4px solid ${isPos ? "#16a34a" : "#dc2626"}`,
        borderRadius: 4,
        padding: "13px 14px",
        transition: "all 0.2s",
        boxShadow: hov
          ? "0 4px 20px rgba(3,105,161,0.12)"
    ...
    >
      ...
      >
        <div>
          ...
          >
            How History Shaped This Category
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 9,
                    color: d.change >= 0 ? "#4ade80" : "#f87171",
                    fontFamily: "monospace",
                  }}
                >
                  {d.change >= 0 ? "▲" : "▼"}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f1f5f9" }}>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              GLOBAL OIL MARKETS & ENERGY INTELLIGENCE PLATFORM
            </div>
          </div>
        </div>
        <div
        ...
        >
              ...
              val: (
                <div style={{ display: "flex", gap: 10 }}>
                  <div>
                    ...
                    <div style={{ fontSize: 7, color: "#16a34a" }}>UP</div>
                  </div>
                  <div>
                    <div
                      style={{
                    ...
                    <div style={{ fontSize: 7, color: "#dc2626" }}>DOWN</div>
                  </div>
                </div>
              ),
              pad: "0 14px",
          ...
          >
            <button
              ...
              style={{
                background: showChart ? "#0f172a" : "#f8fafc",
                border: `1.5px solid ${showChart ? "#f97316" : "#e2e8f0"}`,
                color: showChart ? "#f97316" : "#64748b",
                padding: "6px 11px",
                borderRadius: 4,
                cursor: "pointer",
                fontSize: 9,
            ...
            <button
              ...
              style={{
                background: showChat ? "#0369a1" : "#f8fafc",
                border: `1.5px solid ${showChat ? "#0369a1" : "#e2e8f0"}`,
                color: showChat ? "#fff" : "#0369a1",
                padding: "6px 11px",
                borderRadius: 4,
                cursor: "pointer",
                fontSize: 9,
      ...
      >
        ...
        >
          ⚡ KHAMENEI CONFIRMED DEAD · IRAN RESTRICTS HORMUZ · BRENT TARGETING
          $100 · DUBAI AIRPORT CLOSED · BOMBING CONTINUES THROUGH THE WEEK ·
          MARKETS REOPEN SUNDAY ASIA
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "20px 24px" }}>
          ...
          >
            {TIMELINE.map((e, i) => (
              <TimelineCard
                key={i}
                event={e}
                selected={selEvent?.year === e.year}
                onClick={() =>
                  setSelEvent(selEvent?.year === e.year ? null : e)
                }
              />
            ))}
          </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    {selEvent.year} · {selEvent.price}/BBL ·{" "}
                    {selEvent.label.toUpperCase()}
                  </div>
                  <div
                    style={{
                      fontSize: 15,
        ...
        >
          ...
          >
            BENCHMARK CRUDE — SPOT PRICES (USD / BARREL) · FEB 2026
          </span>
        </div>
        <div
          style={{
        ...
        {showChat && (
          <div
            style={{
              ...
              marginBottom: 22,
              overflow: "hidden",
              boxShadow: "0 4px 24px rgba(3,105,161,0.12)",
            }}
          >
            <div
              style={{
            ...
            >
              ...
              <div>
                ...
                >
                  MARKET ANALYST — OIL INTELLIGENCE ENGINE
                </div>
                <div
                  style={{
                    color: "#bae6fd",
                ...
                >
                  BRENT · WTI · OPEC · IRAN · RUSSIA · CHINA · SHALE · HISTORY ·
                  FORECASTS
                </div>
              </div>
            </div>
            ...
            >
              {chatMsgs.length === 0 && (
                ...
                >
                  Ask anything: "What does Khamenei's death mean for oil?" ·
                  "Will Hormuz close?" · "Goldman's $130 scenario" · "Canada's
                  role now"
                </div>
              )}
              {chatMsgs.map((m, i) => (
                <div
                  ...
                  style={{
                    padding: "10px 13px",
                    borderRadius: 4,
                    background: m.role === "user" ? "#f8fafc" : "#f0f9ff",
                    border: `1px solid ${m.role === "user" ? "#e2e8f0" : "#bae6fd"}`,
            ...
            >
              <input
                ...
                placeholder="Ask about Khamenei, Hormuz, Goldman scenarios, Canada, SPR..."
                style={{
                  flex: 1,
                  border: "1.5px solid #e2e8f0",
                  borderRadius: 4,
        ...
        <div
          style={{ display: "grid", gridTemplateColumns: "195px 1fr", gap: 18 }}
        >
          <div>
            <div
              style={{
            ...
            <div style={{ display: "flex", gap: 4, marginBottom: 10 }}>
              {["news", "history"].map((t) => (
                <button
                  ...
                  style={{
                    flex: 1,
                    background: activeTab === t ? "#0369a1" : "#f8fafc",
                    border: `1.5px solid ${activeTab === t ? "#0369a1" : "#e2e8f0"}`,
              ...
              {CATS.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${activeCat === c.id ? c.color : "#e2e8f0"}`,
                    color: activeCat === c.id ? "#fff" : "#475569",
                    padding: "9px 12px",
                    borderRadius: 4,
                    cursor: "pointer",
                    fontSize: 9,
            ...
            >
              ...
              {[
                { l: "HORMUZ", v: "RESTRICTED", ok: false },
                { l: "KHAMENEI", v: "CONFIRMED DEAD", ok: false },
                { l: "DUBAI AIRPORT", v: "CLOSED", ok: false },
                { l: "IRAN REGIME", v: "COLLAPSING", ok: false },
                { l: "BRENT TARGET", v: "$100+", ok: false },
              ].map((s, i) => (
                <div
                  key={i}
                  style={{
          ...
          <div>
            ...
            {activeTab === "news" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {(NEWS[activeCat] || []).map((a, i) => (
                  <NewsCard
                    key={i}
                    article={a}
                    index={i}
                    color={cat?.color || "#0369a1"}
                  />
                ))}
              </div>
            ) : (
        ...
        >
          ...
          >
            HARD CRUDE INTELLIGENCE © 2026 — FOR INFORMATIONAL PURPOSES ONLY.
          ...
          >
            AI MARKET INTELLIGENCE · 56-YEAR PRICE HISTORY · LIVE DEPLOYMENT
            GUIDE AVAILABLE
          </span>
        </div>
      </div>
