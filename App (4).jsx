    ...
    <div style={{minHeight:"100vh",background:"#f1f5f9"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .hci-header{display:flex;align-items:stretch;justify-content:space-between;padding:0 16px}
        .hci-header-stats{display:flex;align-items:center;border-left:1px solid #e2e8f0}
        .hci-main{max-width:1400px;margin:0 auto;padding:16px}
        .hci-news-grid{display:grid;grid-template-columns:195px 1fr;gap:18px}
        .hci-price-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(190px,1fr));gap:11px;margin-bottom:22px}
        @media(max-width:768px){
          .hci-header{flex-direction:column;padding:0 12px}
          .hci-header-stats{border-left:none;border-top:1px solid #e2e8f0;overflow-x:auto;width:100%}
          .hci-logo-text{font-size:20px!important}
          .hci-main{padding:10px}
          .hci-news-grid{grid-template-columns:1fr!important}
          .hci-price-grid{grid-template-columns:repeat(2,1fr)!important;gap:8px}
          .hci-breaking{padding:8px 12px!important;font-size:10px!important}
          .hci-cats{display:flex!important;flex-direction:row!important;flex-wrap:wrap!important;gap:6px!important}
          .hci-cats button{flex:1!important;min-width:calc(50% - 3px)!important}
        }
        @media(max-width:400px){
          .hci-price-grid{grid-template-columns:1fr!important}
        }
      `}</style>
